...
//            titleLbl.lineHeight(0.70)
     ...
     */
    @IBInspectable public var titleSize:CGFloat = 32
    /**
     ...
     */
    @IBInspectable public var iconRadius: CGFloat = 0 {
        didSet{
     ...
     */
    @IBInspectable public var buttonText: String? = nil {
        didSet{
    ...
    override open func draw(_ rect: CGRect) {
        ...
        titleLbl.font = UIFont.boldSystemFont(ofSize: titleSize)
