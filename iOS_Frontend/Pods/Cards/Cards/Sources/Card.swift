...
@IBDesignable open class Card: UIView, CardDelegate {
     ...
     */
    @IBInspectable public var shadowOpacity: Float = 0.23 {
        didSet{
     ...
     */
    @IBInspectable public var cardRadius: CGFloat = 4 {
        didSet{
    ...
    public func shouldPresent( _ contentViewController: UIViewController?, from superVC: UIViewController?, fullscreen: Bool = false) {
        ...
        if let content = contentViewController {
            ...
            print(self.frame)
//            var v = UIView(frame: self.frame)
//            v.backgroundColor = .red
//            detailVC.view.addSubview(v)
//            detailVC.view.sendSubviewToBack(v)
//            detailVC.card.backgroundColor = .red
        }
    }
    /**
